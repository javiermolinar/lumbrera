...
func TestInitMissingDirectory(t *testing.T) {
	...
	assertFileContains(t, repo, "AGENTS.md", "Command protocol")
	assertFileContains(t, repo, "AGENTS.md", "Lumbrera is agent-driven")
	assertFileContains(t, repo, "AGENTS.md", "Optional external guardrails")
	assertFileContains(t, repo, "AGENTS.md", "tags.md is a generated read-only tag registry")
	...
	assertFileContains(t, repo, ".agents/skills/lumbrera-ingest/SKILL.md", "Wiki linking pass")
